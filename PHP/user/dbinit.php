...
$pdoDatabase->exec('DROP DATABASE IF EXISTS testdb;');
$pdoDatabase->exec('CREATE DATABASE IF NOT EXISTS testdb DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci');
