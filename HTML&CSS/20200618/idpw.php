	...
	<table class="table_re" width="400">
		...
		<tr>
			...
			<table style="font-size:1.0em; color:#666; width:100%; border-collapse:collapse">
				<br><br><h>아이디를 찾고자 하는 회원정보를 입력해 주세요.</h><br><br><br><br>
				<tr>
					<td>이름</td>
					<td>
				...
				<tr>
					<td colspan="2" align="center">
						<input type="button" class="btn1" value="ID 찾기" onclick="send1()">
					</td>
				</tr>
			</table>
			</div>
		...
		<form name="frm2" method="post" action="pw_ok.php">
			<div id="pw_content">
			<table style="font-size:1.0em; color:#666; width:100%; border-collapse:collapse">
				<br><br><h>비밀번호를 찾고자 하는 아이디를 입력해 주세요.</h><br><br><br><br>
				<tr>
					<td>이름</td>
					<td>
				...
				<tr>
					<td colspan="2" align="center">
						<input type="button" class="btn1" value="PW 찾기" onclick="send2()">
					</td>
				</tr>
			</table>
		</div>
